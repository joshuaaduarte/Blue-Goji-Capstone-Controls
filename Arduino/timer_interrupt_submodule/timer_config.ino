...
void timerConfig() {
  ...
  OCR0A = 180; // set compare match register trigger value, increment motor by 5
  ...
  OCR1A = 78; // set compare match register trigger value, increment motor by 5
  TCCR1B |= (1 << WGM12); // turn on CTC mode
  TCCR1B |= (1 << CS12)| (1 << CS10); // Set CS02 bit for 256 prescaler
